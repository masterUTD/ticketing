...
const start = async () => {
 ...
 try {
    ...
    new OrderCreatedListener(natsWrapper.client).listen() // listening for incoming requests
    new OrderCancelledListener(natsWrapper.client).listen()  // listening for incoming requests
